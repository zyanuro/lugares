    ...
    <div class="relative min-h-screen">
        ...
        <div class="fixed bottom-0 left-0 w-full bg-red-900/50 text-white py-32">
            <div class="container mx-auto flex flex-col items-center justify-center h-full">
                ...
                <a href="" class="duration-500 ease-in-out mb-3 font-header shadow-md shadow-white bg-slate-300/50 hover:visited:border-x-gray-400 hover:bg-gray-100 transition-colors cursor-pointer uppercase font-thin text-lg p-1 text-amber-600 hover:text-black rounded-md w-30">Read</a>
            </div>
        </div>
    </div>    
    @endif
