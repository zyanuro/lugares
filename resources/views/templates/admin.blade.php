...
<html class="" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-black">        
        ...
        <a href="{{route('profile.edit')}}"><p class=" font-header text-white hover:border-b-2 hover:border-b-white hover:text-red-600 text-right mr-32 md:text-2xl items-center">{{ Auth::user()->name }}<span class=" text-red-600 hover:text-white">'s Admin area</span></p></a>
