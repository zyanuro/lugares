...
<body class="bg-black">
    ...
    <nav class="bg-black shadow border-t-4  border-t-red-600 border-b-gray-600 w-auto fixed top-0 sticky">
        <div class="container px-6 mx-auto">
            ...
            <!-- right section -->
            <div id="nav-menu"
                class=" bg-black font-header  flex flex-col mt-3 hidden lg:flex lg:flex-row md:mt-0 md:block items-start gap-4 md:gap-0 ">
                ...
                @auth
                    <a class="duration-500 ease-in-out mb-3 font-header shadow-md shadow-white p-2 bg-transparent hover:visited:border-x-gray-400 hover:bg-gray-100 transition-colors cursor-pointer 
                        uppercase font-thin text-lg text-white hover:text-black border border-red-600 rounded-md"
    ...
    <a href="{{ route('profile.edit') }}">
        <p
            ...
            {{ Auth::user()->name }}<span class=" text-red-600 hover:text-white">'s Admin area</span></p>
    </a>
...
<footer
    class="bg-gray-900/50 w-full md:text-xl text-xs text-center text-gray-400 font-bold  max-h-screen fixed bottom-0">
    <div class="p-3 border-t-2 border-b-4 border-red-600"><span class=" text-red-600">Enchanted Places</span> - All
        rights reserved - {{ now()->year }}</div>
