...
@section('contenido')
    ...
    <div class="container mx-auto p-4 mt-0 shadow-2xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 bg-black p-4 rounded-lg">
             ...
             @if ($place->theme->id == 5) bg-slate-400 
              ...
              font-mono font-bold  ">
                        ...
                        <div class="px-10 py-4 ">
                            ...
                            <div class=" text-center @if ($place->theme->id == 1) text-red-600  mb-1 @endif">
                                {{ $place->name }}</div>
                            <hr>
                            <!-- Puntuación -->
                            ...
                            <!-- Fecha de Creación -->
                            <p class=" text-amber-500 text-sm mb-2">Created at: <span
                                    class="text-gray-300 text-xs">{{ $place->created_at }}</span></p>
                            ...
                            <!-- Autor -->
                            <p class="text-slate-900 text-base">Author: <span
                                    class=" text-slate-300">{{ $place->user->name }}</span></p>
                            <!-- Location -->
                            <p class="text-slate-900 text-base">Location: <span
