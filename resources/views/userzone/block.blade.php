...
<div class="flex flex-col space-y-4 items-center mx-5 mt-20">
    <div> 
        <p class="border border-white p-5 mb-7 rounded-xl shadow-red-300 shadow-xl uppercase font-sans text-4xl text-red-300 text-center">This User has been blocked. Please contact whith the administrator. Thanks</p>
    </div>
    <div>
