...
<div class="flex flex-col space-y-4 items-center">
    ...
    <div>
        <a href="{{url('registeredzone.show/'.Auth::user()->id)}}" class="bg-zinc-500 hover:bg-sky-700 transition-colors cursor-pointer uppercase font-bold w-auto p-3 text-white rounded-lg">
        Volver
        </a>
    </div>
</div>
