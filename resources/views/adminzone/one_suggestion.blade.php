...
<body class="bg-gray-100">
    <div class="max-w-screen-lg mx-auto p-4 mt-8">
        <div class="bg-white shadow-lg rounded-lg p-6">
            <p class="text-xl font-bold text-gray-800">User: {{$suggestion->name}} <span class=" text-lg"><span>- address: {{$suggestion->email}} - </span></p> 
            <p class="@if ($suggestion->user->rol == 1) text-green-600 @elseif ($suggestion->user->rol == 2) text-pink-600 @else text-gray-600 @endif">From: @if ($suggestion->user->rol == 1)Registered @elseif ($suggestion->user->rol ==2) Admin @else Anonymou @endif</p>
