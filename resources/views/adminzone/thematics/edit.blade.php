...
<div class="md:flex justify-center md:gap-10 md:items-center m-5">
    ...
    <div class="md:w-4/12 bg-black">
        ...
        <form action="{{url('adminzone/thematics/'.$theme->id)}}" method="POST" class="border border-red-600 rounded-lg p-5">
            @method("PUT")
            @csrf
            ...
            <div class="mb-5">
                ...
                <input 
                   ...
                   name="name"
                   type="text"
                   placeholder="Name of the thematic"
            ...
            <div class="flex gap-3 text-center p-4 font-header text-2xl"><button 
                ...
                <a href="{{url('adminzone/thematics/show')}}" class=" b shadow-red-600 shadow-md border border-slate-200  hover:bg-white transition-colors cursor-pointer w-full p-2 text-slate-400 rounded-lg">
                Back
                </a>
            </div>
