...
@section('contenido')
    ...
    <div class="md:flex justify-center md:gap-10 md:items-center m-5">
        ...
        <div class="md:w-4/12 bg-black">
            ...
            <form action="{{ url('adminzone/thematics/' . $theme->id) }}" method="POST"
                class="border border-red-600 rounded-lg p-5">
                @method('PUT')
                @csrf
                ...
                <div class="mb-5">
                    ...
                    <input id="name" name="name" type="text" placeholder="Name of the thematic"
                        class="border border-red-600 p-3 w-full rounded-lg" value="{{ $theme->name }}" />
                </div>
