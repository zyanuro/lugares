    ...
    <div class="grid grid-cols-1 text-center place-items-center md:flex bg-black md:place-content-center md:mt-10">
        ...
        <div
            ...
            <a href="{{ url('adminzone/show') }}">
                <div
                    class="w-64 h-64 p-5 bg-red-800 rounded-full hover:bg-red-300  text-gray-300 hover:text-gray-900 transition-colors duration-500 ease-in-out flex items-center justify-center">
                    Moderate Places</div>
            </a>
            <a href="{{ url('adminzone/users/index') }}">
                <div
                    class="w-64 h-64 p-5 bg-gray-300 hover:bg-gray-500 rounded-full hover:text-gray-300 transition-colors duration-500 ease-in-out flex items-center justify-center">
                    Moderate Users</div>
            </a>
            <!-- Fila 2 -->
